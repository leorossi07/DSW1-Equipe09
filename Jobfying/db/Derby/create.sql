...
create table Empresa(
    ...
    constraint Empresa_Usuario_FK foreign key (usuario_id) references Usuario(id) on delete cascade
);
...
create table Profissional(
    ...
    constraint Profissional_Usuario_FK foreign key (usuario_id) references Usuario(id) on delete cascade
);
...
create table Vaga(
    ...
    constraint Vaga_Empresa_FK foreign key (empresa_id) references Empresa(id) on delete cascade
);
...
create table Candidatura(
    ...
    constraint Candidatura_Vaga_FK foreign key (vaga_id) references Vaga(id) on delete cascade,
    constraint Candidatura_Profissional_FK foreign key (profissional_id) references Profissional(id) on delete cascade,
